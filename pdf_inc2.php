 ...
 **********************************************************************
 */
define('FPDF_FONTPATH','lib/');
require_once($GLOBALS['PATHTOINTERLEAVE'] . 'lib/fpdf.php');
...
//print "</pre>";
	...
	//Logo
    //$this->Image('images/crm.png',10,8,10,'','','http://www.interleave.nl');
	$this->Ln(10);
	$this->Image($GLOBALS['PATHTOINTERLEAVE'] . 'images/crm.jpg',10,8,60,8,'JPG','http://www.interleave.nl');
    //Arial bold 15
    //$this->Ln(15);
