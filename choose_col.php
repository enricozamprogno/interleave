...
function WriteColorTable( document, ncols ) {
	...
	document.write( "<td style=\"background-color: " + bgcol + ";\">" +
...
function Tog() {
	document.forms['choosecol'].elements['ignored'].style.background = document.forms['choosecol'].elements['hex'].value;
	document.forms['choosecol'].elements['ignored'].value = '<?php echo $var; ?>';
	document.forms['choosecol'].elements['hidden'].value = document.forms['choosecol'].elements['hex'].value;
}

function doit () {
	parent.document.getElementById('<?php echo $_REQUEST['elementname'];?>').value = document.forms['choosecol'].elements['hidden'].value;
...
function SetBG(color) {
    ...
    //location.reload() ;
    document.forms['choosecol'].elements['hex'].value = color ;
...
<form id='choosecol' method='get' action=''><div class='showinline'>
...
<input type='submit' name='but' value='accept' onclick='doit();'>
</div></form>
<script type="text/javascript">
<!--
document.forms['choosecol'].elements['ignored'].value = '<?php echo $var; ?>';
