...
//
//  THIS FILE IS MODIFIED FOR INTERLEAVE ON LINE 27 AND 151.
//
//  FPDI - Version 1.3.2
//
...
if (call_user_func_array('class_exists', $__tmp)) {
    // DISABLED. BREAKS THINGS. EXTRACTING ASCII SEEMS TO WORK FINE WITHOUT THIS
...
class FPDI extends FPDF_TPL {
    ...
    function importPage($pageno, $boxName='/CropBox') {
        ...
        $tpl['box'] = $box;
		// MODIFIED INTERLEAVE HERE
        return(ps2txt($tpl['buffer']));
